...
let header = {
  ...
  useEffect(()=>{
   axios.get('https://backend2-udns.onrender.com/blog/myblogs',{headers:header})
   .then((res)=>setBlogs(res.data))
   .catch((err)=>console.log(err))
  },[])

  const handleDelete = (id) => {
    axios.delete("https://backend2-udns.onrender.com/blog/delete",{headers:header,params:{id:id}}).then((res)=>{
